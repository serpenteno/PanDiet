...
class MealAdmin(admin.ModelAdmin):
    ...
    list_display = ('name', 'description', 'get_products', 'recipe', 'mass', 'tags', 'author', 'visibility')

    # Fields that are searchable
    search_fields = ('name', 'tags', 'mass', 'author', 'visibility', 'products__name')

    # Fields that can be filtered
    list_filter = ('tags', 'author', 'visibility')

    # Fields that can be edited during add or put operations
    fields = ('name', 'description', 'recipe', 'mass', 'tags', 'author', 'visibility')
